...
class Window_1:
    def __init__(self, master):
        self.master = master
        self.master.title("Fees Report Management System")
        self.master.geometry('1350x750')
        self.master.config(bg="greenyellow")
        self.Frame = Frame(self.master, bg="greenyellow")
        self.Frame.pack()
        ...
        self.Lbl_Title = Label(self.Frame, text = 'Login Menu', font = ('arial',55,'bold'), bg = 'orange', fg = 'green')
    ...
    def Login(self):
        ...
        if (u == str('TBG') and p == str('tbg@123')):
            self.__menu__()
        else:
            tkinter.messagebox.askyesno("Login","Error : incorrect Username and Password")
            self.Username.set("")
            self.Password.set("")
...
class Window_2:
    def __init__(self, master):
        self.master = master
        self.master.title("Fees Managment System")
        self.master.geometry('1350x750')
