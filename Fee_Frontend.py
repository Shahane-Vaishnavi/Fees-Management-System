...
class Fee():
    def __init__(self, master):
        self.master = master
        self.master.title('Fees Management System/Fee Report')
        ...
        # ==================================================Frames===================================================
        Main_Frame = Frame(self.master, bg='grey')
        Main_Frame.grid()

        Title_Frame = LabelFrame(
            Main_Frame, width=1350, height=100, bg='grey', relief='ridge', bd=15)
        ...
        Data_Frame = Frame(Main_Frame, width=1350, height=350,
                           bg='grey', relief='ridge', bd=15)
        Data_Frame.pack(side=TOP, padx=15)

        Frame_1 = LabelFrame(Data_Frame, width=850, height=350, bg='lightgreen', relief='ridge', bd=8,
                             text='Informations', font=('arial', 15, 'bold'))
        Frame_1.pack(side=LEFT, padx=10)

        Frame_2 = LabelFrame(Data_Frame, width=495, height=350, bg='lightgreen', relief='ridge', bd=8,
                             text='Fee Receipt', font=('arial', 15, 'bold'))
        Frame_2.pack(side=RIGHT, padx=10)

        List_Frame = Frame(Main_Frame, width=1350, height=150,
                           bg='lightgreen', relief='ridge', bd=15)
        ...
        self.branch_entry = ttk.Combobox(Frame_1, values=(' ', 'CO', 'ME', 'EE'),
                                         font=('arial', 14), width=19, textvariable=self.branch)
        self.branch_entry.grid(row=4, column=1, padx=15, pady=5)

        self.sem_entry = ttk.Combobox(Frame_1, values=(' ', 'FIRST', 'SECOND', 'THIRD'), font=('arial', 14), width=19,
